...
class Win32 (object):
    ...
    def __init__ (self):
        ...
        self._user32 = None
        self._initialize()
        self.legacy = r'C:\Program Files\WinHlp32 Legacy\winhlp32_legacy.exe'
    ...
    def win_help (self, help, key = None):
        HELP_KEY = 0x0101
        HELP_FINDER = 0x000b    # noqa: F841
        HELP_COMMAND = 0x0102   # noqa: F841
        HELP_CONTENTS = 0x0003  # noqa: F841
        HELP_INDEX = 0x0003
        if os.path.exists(self.legacy):
            return self.legacy_help(help, key)
    ...
    def legacy_help (self, help, key = None):
        test = self.legacy
...
if __name__ == '__main__':
    def test1():
        win32 = Win32()
        win32.win_help('d:/dev/help/help/win32.hlp', 'MessageBox')
    ...
    def test2():
        win32 = Win32()
        win32.legacy_help('d:/dev/help/help/win32.hlp', 'MessageBox')
        # win32.legacy_help('d:/dev/help/help/win32.hlp')
        time.sleep(0.5)
        return 0
